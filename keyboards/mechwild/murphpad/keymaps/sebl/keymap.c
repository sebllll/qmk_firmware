...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        //           KC_F5,   KC_F6,   KC_F7
                  ...
                  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        KC_MUTE,  KC_P4,   KC_P5,   KC_P6,   _______,
        TO(_FN1), KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        TO(_FN3),  KC_P0,  KC_COMMA,KC_PDOT, _______,
    ...
    [_FN1] = LAYOUT(
        ...
        //          _______,  _______, _______
                  KC_F1,   KC_F2,   KC_F3,   KC_F4,
                  KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
                  KC_A,    KC_B,    KC_C,   KC_PPLS,
        KC_MUTE,  KC_P4,   KC_P5,   KC_P6,   _______,
        TO(_FN2), KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        TO(_BASE),  KC_P0,  KC_COMMA,KC_PDOT, _______,
    ...
    [_FN2] = LAYOUT(
                  ...
                  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        KC_MUTE,  KC_P4,   KC_P5,   KC_P6,   _______,
        TO(_FN3), KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        TO(_FN1),  KC_P0,  KC_COMMA,KC_PDOT, _______,
    ...
    [_FN3] = LAYOUT(
                  ...
                  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        KC_MUTE,  KC_P4,   KC_P5,   KC_P6,   _______,
        TO(_BASE), KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        TO(_FN2),  KC_P0,  KC_COMMA,KC_PDOT, _______,
